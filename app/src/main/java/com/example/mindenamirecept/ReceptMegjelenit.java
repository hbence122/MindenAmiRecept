    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReceptReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child("receptHozz1").exists()){
                ...
                if (dataSnapshot.child("receptHozz2").exists()){
                ...
                if (dataSnapshot.child("receptHozz3").exists()){
                ...
                if (dataSnapshot.child("receptHozz4").exists()){
                ...
                if (dataSnapshot.child("receptHozz5").exists()){
                ...
                if (dataSnapshot.child("receptHozz6").exists()){
                ...
                if (dataSnapshot.child("receptHozz7").exists()){
                ...
                if (dataSnapshot.child("receptHozz8").exists()){
                ...
                if (dataSnapshot.child("receptHozz9").exists()){
                ...
                if (dataSnapshot.child("receptHozz10").exists()){
                ...
                if (dataSnapshot.child("receptHozz11").exists()){
                ...
                if (dataSnapshot.child("receptHozz12").exists()){
                ...
                if (dataSnapshot.child("receptHozz13").exists()){
                ...
                if (dataSnapshot.child("receptHozz14").exists()){
                ...
                if (dataSnapshot.child("receptHozz15").exists()){
                ...
                if (dataSnapshot.child("receptHozz16").exists()){
                ...
                if (dataSnapshot.child("receptHozz17").exists()){
                ...
                if (dataSnapshot.child("receptHozz18").exists()){
                ...
                if (dataSnapshot.child("receptHozz19").exists()){
